...
public:
	...
	virtual void display() = 0; // перегрузка без параметров
protected:
...
public:
	...
	void display() override; // сохраняет по умолчанию в mushroom.pgm
...
public:
	...
	void display() override; // сохраняет по умолчанию в house.ppm
